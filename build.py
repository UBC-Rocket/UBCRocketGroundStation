...
EXTERNAL_DEPENDENCIES = {
    'https://github.com/openrocket/openrocket/releases/download/release-24.12.beta.01/OpenRocket-24.12.beta.01.jar':
        os.path.join(LOCAL, 'OpenRocket-24.12.beta.01.jar'),
}
