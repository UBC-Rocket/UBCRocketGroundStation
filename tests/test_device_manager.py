import pytest
from main_window.device_manager import DeviceManager, DeviceType, FullAddress, InvalidRegistration, DEVICE_REGISTERED_EVENT
...
def test_normal_registration():
    ...
    device_manager.register_device(DeviceType.TANTALUS_STAGE_1, full_address_1)
    device_manager.register_device(DeviceType.TANTALUS_STAGE_2, full_address_2)
...
def test_existing_device():
    ...
    with pytest.raises(InvalidRegistration):
        device_manager.register_device(DeviceType.TANTALUS_STAGE_1, full_address_2)
...
def test_existing_full_address():
    ...
    with pytest.raises(InvalidRegistration):
        device_manager.register_device(DeviceType.TANTALUS_STAGE_2, full_address_1)
